...
t=0
dt=0.001
com=(ballA.pos*ballA.m+ballB.pos*ballB.m)/(ballA.m+ballB.m)
comv=(ballA.p+ballB.p)/(ballA.m+ballB.m)
contact= False
while t<1.6:
  rate(1000)
  FA=vector(0,0,0)
